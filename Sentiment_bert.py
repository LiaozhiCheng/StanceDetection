...
model = BertForSequenceClassification.from_pretrained('ckiplab/bert-tiny-chinese', num_labels=3).to(device)
...
stance_dataset = SentimentDataset(train_title, train_title_tokenized, train_sentiment)
